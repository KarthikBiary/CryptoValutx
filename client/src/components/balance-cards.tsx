    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <Card className="gradient-purple text-white border-0">
        <CardContent className="p-6">
          ...
          <div>
            <p className="text-2xl font-bold">{balances.SOL.toFixed(2)}</p>
      ...
      <Card className="bg-card border-border">
        <CardContent className="p-6">
          ...
          <div>
            <p className="text-2xl font-bold">{balances.USDC.toFixed(2)}</p>
      ...
      <Card className="bg-card border-border">
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[hsl(var(--solana-green))] text-sm">+2.4%</span>
          </div>
          <div>
            <p className="text-2xl font-bold">{formatCurrency(balances.totalValue)}</p>
